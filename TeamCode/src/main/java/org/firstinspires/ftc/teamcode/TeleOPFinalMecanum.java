...
public class TeleOPFinalMecanum extends OpMode
{
    ...
    public void loop()
    {
        ...
        if(gamepad2.x && pivotBrat.getPosition() >= 0.17)
            pivotBrat.setPosition(pivotBrat.getPosition()-0.01);
        ...
        rataStanga = gamepad1.left_trigger;
        rataDreapta = gamepad1.right_trigger;
        
        if(rataStanga > 0) robot.carusel.setPower(rataStanga);
        else if(rataDreapta > 0) robot.carusel.setPower(-rataDreapta);
        else {

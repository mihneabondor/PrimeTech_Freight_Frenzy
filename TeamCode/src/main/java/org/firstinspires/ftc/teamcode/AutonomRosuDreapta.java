...
@Disabled
@Autonomous(name="AutonomRosuDreapta mecanum")
public class AutonomRosuDreapta extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        if(robot.distanta.getDistance(DistanceUnit.CM) <= 32) 
        {
            ///telemetry.addData("caz 2", robot.distanta.getDistance(DistanceUnit.CM));
            sleep(1000);
            StrafeRight(100, 0.4);
            sleep(1000);
            ...
            sleep(3);
            DriveBackward(37, 0.5, 0.5, 0.5, 0.5);
            StopAllMotion();
            ...
            StrafeLeft(90, 0.4);
            StopAllMotion();
            DriveForward(190, 0.5, 0.5, 0.5, 0.5);
            StrafeRight(110, 0.4);
            StopAllMotion();
            sleep(1000);
        }
        else
        {
            ...
            {
                telemetry.addData("caz 1", robot.distanta.getDistance(DistanceUnit.CM));
                sleep(1000);
                StrafeRight(50, 0.4);
                sleep(1000);
                robot.ridicare.setPower(-0.1);
            ...
            telemetry.addData("caz 3", robot.distanta.getDistance(DistanceUnit.CM));
            sleep(1000);
            StrafeRight(50, 0.4);
            sleep(1000);
            ...
            robot.ridicare.setPower(0.1);
            sleep(10);
            DriveForward(180, 0.5, 0.5, 0.5, 0.5);
            StrafeRight(110, 0.4);
            }
        }

...
@Disabled
@Autonomous(name="AutonomRosuParcare")
public class AutonomDreaptaParcare extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        if(robot.distanta.getDistance(DistanceUnit.CM) <= 35) {
            ...
            sleep(100);
            StopAllMotion();
            DriveForward(37, 0.5, 0.3, 0.5, 0.5);
            StopAllMotion();
            sleep(500);
            ...
            sleep(10);
            DriveBackward(37, 0.5, 0.2, 0.5, 0.5);
            StopAllMotion();
            RotateRight(60);
            StrafeLeft(85, 0.4);
            StopAllMotion();
            DriveForward(215, 0.7, 0.3, 0.7, 0.7);
        }
        
        RotateRight(75);
        ///DriveForward(40, 0.5, 0.2, 0.5, 0.5);
        topAllMotion();
        StrafeLeft(85, 0.4);
        StopAllMotion();*/
        DriveForward(100, 0.7, 0.3, 0.7, 0.7);
        StrafeRight(100, 0.4);
